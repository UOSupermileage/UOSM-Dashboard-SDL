...
#else
#define MCP2515_CS_HIGH()  // SPI Chip Select High
#define MCP2515_CS_LOW()  // SPI Chip Select Low
#define MCP2515_SPI_TRANSMIT(BUFFER, SIZE)  // SPI Transmit
#define MCP2515_SPI_RECEIVE(BUFFER, SIZE)  // SPI Receive
#define MCP2515_SPI_READY true // SPI Ready
#ifdef __cplusplus
extern "C" {
#endif
