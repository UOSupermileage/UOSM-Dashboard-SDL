...
void tft_init(void)
{
    ...
    DebugPrint("Configuring LCD");
    LCD_Config();

    DebugPrint("Writing to DSI");
    ...
    DebugPrint("Registering lv driver");
